...
\includegraphics[scale=0.2]{Images/Logo wit.png}

\vfill
\end{frame}

\usebackgroundtemplate{} % reset background
}
}

\newcommand{\titlepagecustomWithPicture}{
{
\usebackgroundtemplate{
    \includegraphics[
        width=\paperwidth,
...
\includegraphics[scale=0.2]{Images/casper.jpg}
